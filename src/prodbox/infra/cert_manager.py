...
from prodbox.infra.metadata import object_meta, prodbox_labels
    ...
    *,
    ...
    release = k8s.helm.v3.Release(
        ...
        values={
            ...
            # Prodbox labels on pods (cert-manager does not support top-level commonLabels)
            "podLabels": prodbox_labels(prodbox_id),
