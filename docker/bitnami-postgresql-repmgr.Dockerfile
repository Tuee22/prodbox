...
COPY docker/bitnami/postgresql-repmgr/prebuildfs /
...
RUN --mount=type=secret,id=downloads_url,env=SECRET_DOWNLOADS_URL \
    ...
    COMPONENTS=( \
      ...
      "postgresql-repmgr-17.6.0-1-linux-${OS_ARCH}-debian-12" \
    ) ; \
...
COPY docker/bitnami/postgresql-repmgr/rootfs /
...
ENV APP_VERSION="17.6.0" \
    ...
    PATH="/opt/bitnami/common/bin:/opt/bitnami/repmgr/bin:/opt/bitnami/postgresql/bin:$PATH"
