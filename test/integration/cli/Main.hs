    ...
    describe "native Haskell config CLI" $ do
        ...
        it "runs native rke2 install and delete through the built frontend with fake host, kubectl, helm, docker, and native AWS destroy helpers" $
            withSystemTempDirectory "prodbox-hs-cli" $ \tmpDir -> do
                ...
                dockerRecord `shouldContain` "buildx|imagetools|inspect|--raw|docker.io/envoyproxy/gateway:v1.7.2"
                dockerRecord `shouldContain` "buildx|imagetools|inspect|--raw|docker.io/envoyproxy/envoy:distroless-v1.37.0"
                ...
                dockerRecord `shouldContain` "buildx|imagetools|create|--tag|127.0.0.1:30080/prodbox/envoy-gateway-mirror:v1.7.2|docker.io/envoyproxy/gateway@sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa|docker.io/envoyproxy/gateway@sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"
                dockerRecord `shouldContain` "buildx|imagetools|create|--tag|127.0.0.1:30080/prodbox/envoy-proxy-mirror:distroless-v1.37.0|docker.io/envoyproxy/envoy@sha256:aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa|docker.io/envoyproxy/envoy@sha256:bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"
