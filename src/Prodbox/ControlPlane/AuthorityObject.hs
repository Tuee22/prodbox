...
-- | Shared authority-object value types and validation. The dedicated
-- Lifecycle Authority and bootstrap transports reuse these structures; the
-- Gateway Runtime exposes no object-store HTTP route.
module Prodbox.ControlPlane.AuthorityObject
...
authorityPulumiObjectPayloadMaxBytes = 64 * 1024 * 1024
