...
| Shared public-edge route catalog | Haskell-owned single-host route catalog, path-prefix constants, canonical public-route URL construction, and Keycloak issuer derivation consumed by lifecycle, DNS, chart, host-diagnostic, supported-runtime, and native validation surfaces | `src/Prodbox/PublicEdge.hs` |
