...
def start(config_path: str) -> None:
    ...
    until interrupted. Inside the canonical in-cluster deployment this
    is invoked as the entrypoint of the gateway pod by the gateway chart;
    no host-side supervisor is supported.
    """
